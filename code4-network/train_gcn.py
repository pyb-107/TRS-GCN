...
def train(path):
    ...
    save_model_to = f'./saved-models/ds/GG-GCN_{timestamp}'  # 文件夹名带上时间戳
    os.makedirs(save_model_to, exist_ok=True)

    ####### data #######
    data_path = os.path.join(os.getcwd(), 'datasets', 'ds', 'train', path)
    # 拼接出所有训练数据的地址
...
if __name__ == '__main__':
  train('trainData-with-solve_1500_3000testtop10')